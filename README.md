<img alt="GitHub Downloads (all releases)" src="https://img.shields.io/github/downloads/YonCursedMC/Uncertain_Error371/total?style=for-the-badge">

# Minecraft Uncertain Error371
...
- JNA(Java Native Access)を利用しています。とんでもないことが起こるので注意してプレイしてください。(最悪の事態は起こらないのでご安心ください。)
...
https://github.com/YonCursedMC/Uncertain_Error371/releases/latest<br>
こちらの一番上の```Uncertain_Error371.zip```<br>
...
https://github.com/YonCursedMC/Uncertain_Error371/releases/latest<br>
The top one here is ``Uncertain_Error371.zip```<br>
